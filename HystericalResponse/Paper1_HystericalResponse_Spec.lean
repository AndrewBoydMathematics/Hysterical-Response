...
3. Constructive response (rest)  → ConstructiveResponse
4. Neutrality + survival         → Paper1_1_TypicalBranchNeutrality_Spec
                                   Paper1_1_GravitationalSurvival_Spec
5. Critical instability          → Paper1_2_NeutralityInstability_Spec_v2
6. Infrared equivalence          → Paper1_3_InfraredEquivalence_Spec
