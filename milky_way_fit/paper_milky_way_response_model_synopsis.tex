...
Paper~2 fixes the BTFR \emph{exponent} but not the zero point.
Adopting the empirical BTFR normalization $V_Q^4=Ga_0\Mb$ with $a_0=1.20\times10^{-10}\,\mathrm{m\,s^{-2}}$ and $\Mb=6.65\times10^{10}\Msun$,
\[
  V_Q=180.4\,\kms.
\]
...
$V_Q^4=Ga_0\Mb$ is a phenomenological normalization (Paper~2 left the BTFR zero point open).
