...
\item Accretion $\to Q$ (Paper~1): $Q=\alpha J_{\mathrm{in}}^{\mathrm{tot}}=\alpha\dot N_{\mathrm{acc}}$ when accretion supplies unentangled arrivals; not the unit identity $Q=\dot\Mb$.
...
\item Not claimed: new force carriers; microscopic $C,A,\alpha$; Galactic numerical fits; proof of the formation requirement from the spatial model.
\end{itemize}
